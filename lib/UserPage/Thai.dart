...
class ThaiBankPage extends StatefulWidget {
  ThaiBankPage({Key key}) : super(key: key);

  @override
  _ThaiBankPageState createState() => _ThaiBankPageState();
}

class _ThaiBankPageState extends State<ThaiBankPage> {
  var _orId;
  var _saveSale;
  var bank = 'ธนาคารกรุงไทย';
  var change = '4';
