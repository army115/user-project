...
class KSKBankPage extends StatefulWidget {
  KSKBankPage({Key key}) : super(key: key);

  @override
  _KSKBankPageState createState() => _KSKBankPageState();
}

class _KSKBankPageState extends State<KSKBankPage> {
  var _orId;
  var _saveSale;
  var bank = 'ธนาคารกสิกรไทย';
  var change = '4';
  ...
  Future getInfo() async {
    ...
    // _saveDate = _rec_order['save_date'];
    // _saveTime = _rec_order['save_time'];
