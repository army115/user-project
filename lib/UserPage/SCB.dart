...
class SBCBankPage extends StatefulWidget {
  SBCBankPage({Key key}) : super(key: key);

  @override
  _SBCBankPageState createState() => _SBCBankPageState();
}

class _SBCBankPageState extends State<SBCBankPage> {
  var _orId;
  var _saveSale;
  var bank = 'ธนาคารไทยพาณิช';
  var change = '4';
